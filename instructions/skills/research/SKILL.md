...
Apply <skill>research-task</skill> directly.
...
Require the subagent to apply <skill>research-task</skill> and return a structured report. The subagent must not write the final research file or spawn additional agents.
...
Require each subagent to apply <skill>research-task</skill>. Subagents must not expand their scope, write the final research file, or spawn additional agents.
