---
name: cr-scope
description: Define goals, constraints, and boundaries.
disable-model-invocation: true
---

# Scope Skill

Use this skill with <skill>cr-question-guidelines</skill> to develop a clear, shared direction.
...
Let <skill>cr-question-guidelines</skill> control the interrogation style, focused on decisions affecting scope.
