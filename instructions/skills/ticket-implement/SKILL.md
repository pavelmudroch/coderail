...
---
Call `tools/ticket.sh activate <ticket-id>` script when starting implementation.
Do not move ticket files or edit ticket lifecycle frontmatter by hand.

The id of ticket is numeric prefix in file name, e.g. for `0001-some-feature.md` the ticket id is `0001`.
