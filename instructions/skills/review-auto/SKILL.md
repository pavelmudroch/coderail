---
name: review-auto
description: Review a completed ticket and record concrete remediation through normal ticket operations.
---
...
Use <skill>ticket-create</skill>. Leave the reviewed ticket closed. The
